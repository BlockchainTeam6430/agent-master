...
namespace Installer
{
    class Program
    {
        static string[] resources = { "action.exe", "action_32bit.exe", "install.dll", "install_32bit.dll", "ServiceYerra.exe", "uninstall.dll", "uninstall_32bit.dll", "YerraAgent.exe"};
        ...
        static void DirectoryDelete(string sourceDirName)
        {
